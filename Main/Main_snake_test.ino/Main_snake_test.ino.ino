...
void setup() {
  ...
  int button_pins[] = {33, 31, 29, 27, 25, 23}; // pins for the controller to use for the buttons
  controller.start(button_pins);
  controller.read_buttons(); // initial read of the buttons. Probably not necessary as all the buttons are initialized to LOW, but doesn't hurt.
